		...
		<form:form action="/account/register" modelAttribute="user" enctype="multipart/form-data">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div class="form-group">
						<label>Xác nhận mật khẩu</label> <input name="confirm" type="password" value="${param.confirm}"
					...
					<div class="form-group">
						<label>Hình đại diện</label> <input type="file" name="photo_file" class="form-control" />
